  ...
  HtmlParser = (function() {
    ...
    HtmlParser.prototype.attr = function(ele, attribute, direct) {
      ...
      if (direct) {
        ...
        return typeof ele.getAttribute === "function" ? ele.getAttribute(attribute) : void 0;
      }
    };
    ...
    HtmlParser.prototype.isVisible = function(ele) {
      var display, properties, property, style, visibility, visible, _i, _len;
    ...
    HtmlParser.prototype.process = function(ele) {
      var after, after1, after2, childNode, href, i, index, level, skipChildren, src, summary, title, _i, _len, _ref3, _ref4;
