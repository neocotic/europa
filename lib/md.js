...
(function() {
  var DEFAULT_OPTIONS, HtmlParser, Node, PREVIOUS_MD, REGEX, REPLACEMENTS, R_HIDDEN_STYLES, R_HIDDEN_VALUE, R_IGNORE_CHILDREN, R_PARAGRAPH_ONLY, doc, jsdom, key, md, result, value, win, _ref, _ref1, _ref2,
  ...
  HtmlParser = (function() {
    ...
    HtmlParser.prototype.isVisible = function(ele) {
      var display, properties, property, style, visibility, visible, _i, _len, _ref3, _ref4, _ref5;
      properties = (_ref3 = ele.attributes) != null ? (_ref4 = _ref3.style) != null ? (_ref5 = _ref4.value) != null ? _ref5.match(R_HIDDEN_STYLES) : void 0 : void 0 : void 0;
      visible = true;
      if (properties != null) {
      ...
      if (visible && (win.getComputedStyle != null)) {
        try {
    ...
    HtmlParser.prototype.process = function(ele) {
      var after, after1, after2, childNode, i, index, level, skipChildren, summary, _i, _len, _ref3, _ref4;
