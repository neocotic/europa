(function() {
  ...
  HtmlParser = (function() {
    ...
    HtmlParser.prototype.process = function(ele) {
      var after, after1, after2, childNode, err, href, i, index, level, prefix, skipChildren, src, summary, title, _i, _len, _ref3, _ref4;
          ...
          if (R_IGNORE_CHILDREN.test(ele.tagName)) {
            ...
            switch (ele.tagName) {
              ...
              case 'UL':
                ...
                break;
              case 'LI':
                prefix = this.inOrderedList ? "" + (this.order++) + ". " : '* ';
                this.output(padLeft(prefix, this.listDepth * 2));
                break;
              case 'PRE':
