(function() {
  ...
  REGEX = ((function() {
    ...
    for (key in REPLACEMENTS) {
      if (!hasProp.call(REPLACEMENTS, key)) continue;
  ...
  HtmlParser = (function() {
    function HtmlParser(html1, options1) {
      var defaultValue, doc;
      this.html = html1 != null ? html1 : '';
      ...
      for (key in DEFAULT_OPTIONS) {
        if (!hasProp.call(DEFAULT_OPTIONS, key)) continue;
      ...
      if (this.win == null) {
        doc = require('jsdom').jsdom(void 0, {
          features: {
    ...
    HtmlParser.prototype.isVisible = function(ele) {
      var display, err, j, len, properties, property, style, visibility, visible;
    ...
    HtmlParser.prototype.parse = function() {
      var container, i, j, len, link, ref, tag, unhandledTags;
      this.buffer = '';
      if (!this.html) {
        return this.buffer;
      }
      ...
      if (this.options.debug) {
        unhandledTags = ((function() {
          ...
          results = [];
          for (tag in ref1) {
            if (!hasProp.call(ref1, tag)) continue;
            results.push(tag);
          }
          return results;
        }).call(this)).sort();
    ...
    HtmlParser.prototype.process = function(ele) {
      var after, after1, after2, base, childNode, err, href, i, j, len, level, ref, ref1, skipChildren, src, suffix, summary, title;
          ...
          if (R_IGNORE_CHILDREN.test(ele.tagName)) {
            ...
            switch (ele.tagName) {
              ...
              case 'IFRAME':
                skipChildren = true;
                try {
                  if ((ref = ele.contentDocument) != null ? ref.documentElement : void 0) {
