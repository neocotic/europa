(function() {
  var DEFAULT_OPTIONS, HtmlParser, Node, PREVIOUS_MD, REGEX, REPLACEMENTS, R_HIDDEN_STYLES, R_HIDDEN_VALUE, R_IGNORE_CHILDREN, R_PARAGRAPH_ONLY, doc, jsdom, key, md, padLeft, result, trim, win, _ref, _ref1, _ref2, _ref3,
    __hasProp = {}.hasOwnProperty,
    _this = this;

  DEFAULT_OPTIONS = {
    absolute: false,
    base: (_ref = this.document) != null ? _ref.baseURI : void 0,
    debug: false,
    inline: false
  };
  ...
  Node = (_ref1 = win.Node) != null ? _ref1 : {};

  if ((_ref2 = Node.ELEMENT_NODE) == null) {
    Node.ELEMENT_NODE = 1;
  }

  if ((_ref3 = Node.TEXT_NODE) == null) {
    Node.TEXT_NODE = 3;
  }
  ...
  HtmlParser = (function() {
    function HtmlParser(html, options) {
      ...
      if (typeof window === "undefined" || window === null) {
        win.document.baseURI = this.options.base;
      }
    }
    ...
    HtmlParser.prototype.parse = function() {
      var container, i, link, tag, unhandledTags, _i, _len, _ref4;
      ...
      if (this.options.debug) {
        unhandledTags = ((function() {
          ...
          _ref5 = this.unhandled;
          _results = [];
          for (tag in _ref5) {
            if (!__hasProp.call(_ref5, tag)) continue;
            _results.push(tag);
          }
          return _results;
        }).call(this)).sort();
    ...
    HtmlParser.prototype.process = function(ele) {
      var after, after1, after2, childNode, err, href, i, level, skipChildren, src, suffix, summary, title, _base, _i, _len, _ref4, _ref5, _ref6;
          ...
          if (R_IGNORE_CHILDREN.test(ele.tagName)) {
            ...
            switch (ele.tagName) {
              ...
              case 'A':
                ...
                suffix = this.options.inline ? "(" + href + ")" : "[" + ((_ref4 = (_base = this.linkMap)[href]) != null ? _ref4 : _base[href] = this.links.push(href) - 1) + "]";
                this.output('[');
                this.atNoWS = true;
              ...
              case 'IFRAME':
                skipChildren = true;
                try {
                  if ((_ref5 = ele.contentDocument) != null ? _ref5.documentElement : void 0) {
