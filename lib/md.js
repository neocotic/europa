(function() {
  ...
  HtmlParser = (function() {
    ...
    HtmlParser.prototype.attr = function(ele, attribute, direct) {
      ...
      value = direct ? ele[attribute] : typeof ele.getAttribute === "function" ? ele.getAttribute(attribute) : void 0;
    ...
    HtmlParser.prototype.has = function(ele, attribute) {
      return !!(typeof ele.hasAttribute === "function" ? ele.hasAttribute(attribute) : void 0);
    };
